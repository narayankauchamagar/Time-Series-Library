...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_id', type=str, default='nepse', help='model id')
    ...
    parser.add_argument('--use_multi_gpu', type=bool, default=True, action='store_true', help='use multiple gpus')
